...
public class login extends javax.swing.JFrame {
    ...
    public login() {
        initComponents();
        txUser.setBackground(new java.awt.Color(0,0,0,1));
        txPass.setBackground(new java.awt.Color(0,0,0,1));
    ...
    private void initComponents() {
        ...
        txUser.setFont(txUser.getFont().deriveFont(txUser.getFont().getSize()+2f));
        txUser.setForeground(new java.awt.Color(255, 255, 255));
        txUser.setBorder(null);
        jPanel2.add(txUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(39, 140, 240, 30));
        ...
        txPass.setFont(txPass.getFont().deriveFont(txPass.getFont().getSize()+2f));
        ...
        jPanel2.add(txPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 210, 240, 30));
         ...
         try {
            ...
            if(rs.next()){
                if(rs.getString("level").equals("admin")){
                    //admin.formAdmin1 fa = new admin.formAdmin1();
                    admin.menu fa = new admin.menu();
                    fa.show();
                    this.dispose();
                }else if(rs.getString("level").equals("user")){
                    user.formUser fu = new user.formUser();
                    fu.show();
                    this.dispose();
                }
            }else{
